...
INSERT INTO "new_Plan" ("description", "id", "interval", "intervalCount", "isUsageBased", "name", "price", "productId", "productName", "sort", "trialInterval", "trialIntervalCount", "variantId") SELECT "description", "id", "interval", "intervalCount", "isUsageBased", "name", "price", "productId", "productName", "sort", "trialInterval", "trialIntervalCount", "variantId" FROM "Plan";
DROP TABLE "Plan";
