...
INSERT INTO "new_Subscription" ("customerId", "email", "endsAt", "id", "isPaused", "isUsageBased", "lemonSqueezyId", "name", "orderId", "planId", "renewsAt", "status", "statusFormatted", "trialEndsAt", "userId") SELECT "customerId", "email", "endsAt", "id", "isPaused", "isUsageBased", "lemonSqueezyId", "name", "orderId", "planId", "renewsAt", "status", "statusFormatted", "trialEndsAt", "userId" FROM "Subscription";
