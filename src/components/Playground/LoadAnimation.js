export function LoadAnimation() {
	return (
		<div className="relative mt-2 w-full animate-pulse overflow-hidden rounded-md border-0 py-4 pr-2.5 pl-2.5 text-slate-900 shadow-xs ring-1 ring-slate-300 ring-inset">
